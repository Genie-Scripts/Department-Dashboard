...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initializeDefaultView = () => {
        ...
        const hospitalButton = Array.from(quickButtons).find(btn => 
            btn.dataset.fragment && btn.dataset.fragment.includes('hospital')
        );
        ...
        if (hospitalButton) {
            ...
            console.warn('病院全体ボタンが見つかりません');
            // フォールバック: fragments/hospital.html を直接読み込み
            loadContent('fragments/hospital.html', true);
        }
    };
